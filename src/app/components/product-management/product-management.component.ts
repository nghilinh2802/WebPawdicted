...
//     try {
//       // Lấy danh sách biến thể và sản phẩm hiện tại
//       const allProducts = await this.productService.getProducts().pipe(take(1)).toPromise();
//       const allVariants = await this.productService.getVariants('').pipe(take(1)).toPromise(); // Lấy tất cả biến thể
